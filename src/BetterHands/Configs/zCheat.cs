...
namespace BetterHands.Configs
{
	public class CheatConfig
	{
		...
		public ConfigEntry<CursedTriggerDriverOptions> CursedTriggersDriver { get; }
		...
		public CheatConfig(ConfigFile config, string section)
		{
			...
			CursedTriggersDriver = config.Bind(section, nameof(CursedTriggersDriver), CursedTriggerDriverOptions.Underbarrel, "Determines if firing the primary or underbarrel weapon will fire the other attached underbarrel weapons");
